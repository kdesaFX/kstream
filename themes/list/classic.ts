...
const tokens = {
  ...
  blue: {
    c50: "hsla(175, 80%, 82%, 1)",
    c100: "hsla(175, 55%, 64%, 1)",
    c200: "hsla(175, 55%, 52%, 1)",
    c300: "hsla(175, 50%, 39%, 1)",
    c400: "hsla(175, 52%, 30%, 1)",
    c500: "hsla(175, 48%, 22%, 1)",
    c600: "hsla(175, 45%, 18%, 1)",
    c700: "hsla(175, 42%, 15%, 1)",
    c800: "hsla(175, 35%, 9%, 1)",
    c900: "hsla(175, 30%, 6%, 1)",
  },
  purple: {
    c50: "hsla(170, 100%, 83%, 1)",
    c100: "hsla(170, 90%, 72%, 1)",
    c200: "hsla(170, 75%, 58%, 1)",
    c300: "hsla(170, 65%, 48%, 1)",
    c400: "hsla(170, 70%, 40%, 1)",
    c500: "hsla(172, 65%, 32%, 1)",
    c600: "hsla(173, 60%, 26%, 1)",
    c700: "hsla(174, 55%, 19%, 1)",
    c800: "hsla(175, 50%, 14%, 1)",
    c900: "hsla(176, 45%, 9%, 1)",
  },
  ash: {
  ...
  shade: {
    c25: "hsla(175, 33%, 53%, 1)",
    c50: "hsla(175, 17%, 48%, 1)",
    c100: "hsla(175, 20%, 40%, 1)",
    c200: "hsla(175, 20%, 31%, 1)",
    c300: "hsla(175, 22%, 25%, 1)",
    c400: "hsla(175, 25%, 21%, 1)",
    c500: "hsla(175, 26%, 16%, 1)",
    c600: "hsla(175, 31%, 12%, 1)",
    c700: "hsla(175, 29%, 10%, 1)",
    c800: "hsla(175, 30%, 8%, 1)",
    c900: "hsla(175, 29%, 5%, 1)",
  },
};
