...
interface Config {
  ...
  ENABLE_SECONDARY_RAIL_AD: boolean;
  ENABLE_DISCOVER_SEAM_AD: boolean;
  DISCOVER_SEAM_AD_ZONE_ID: string;
  ENABLE_DISCOVER_AD: boolean;
  DISCOVER_AD_ZONE_ID: string;
  ENABLE_SEARCH_AD: boolean;
  SEARCH_AD_ZONE_ID: string;
  SEARCH_AD_MOBILE_ZONE_ID: string;
  ENABLE_MANGA_MID_AD: boolean;
  MANGA_MID_AD_ZONE_ID: string;
  ENABLE_FOOTER_AD: boolean;
  FOOTER_AD_ZONE_ID: string;
  ENABLE_ONBOARDING_AD: boolean;
  ONBOARDING_AD_ZONE_ID: string;
...
export interface RuntimeConfig {
  ...
  ENABLE_SECONDARY_RAIL_AD: boolean;
  ENABLE_DISCOVER_SEAM_AD: boolean;
  DISCOVER_SEAM_AD_ZONE_ID: string | null;
  ENABLE_DISCOVER_AD: boolean;
  DISCOVER_AD_ZONE_ID: string | null;
  ENABLE_SEARCH_AD: boolean;
  SEARCH_AD_ZONE_ID: string | null;
  SEARCH_AD_MOBILE_ZONE_ID: string | null;
  ENABLE_MANGA_MID_AD: boolean;
  MANGA_MID_AD_ZONE_ID: string | null;
  ENABLE_FOOTER_AD: boolean;
  FOOTER_AD_ZONE_ID: string | null;
  ENABLE_ONBOARDING_AD: boolean;
  ONBOARDING_AD_ZONE_ID: string | null;
...
const env: Record<keyof Config, undefined | string> = {
  ...
  ENABLE_SECONDARY_RAIL_AD: import.meta.env.VITE_ENABLE_SECONDARY_RAIL_AD,
  ENABLE_DISCOVER_SEAM_AD: import.meta.env.VITE_ENABLE_DISCOVER_SEAM_AD,
  DISCOVER_SEAM_AD_ZONE_ID: import.meta.env.VITE_DISCOVER_SEAM_AD_ZONE_ID,
  ENABLE_DISCOVER_AD: import.meta.env.VITE_ENABLE_DISCOVER_AD,
  DISCOVER_AD_ZONE_ID: import.meta.env.VITE_DISCOVER_AD_ZONE_ID,
  ENABLE_SEARCH_AD: import.meta.env.VITE_ENABLE_SEARCH_AD,
  SEARCH_AD_ZONE_ID: import.meta.env.VITE_SEARCH_AD_ZONE_ID,
  SEARCH_AD_MOBILE_ZONE_ID: import.meta.env.VITE_SEARCH_AD_MOBILE_ZONE_ID,
  ENABLE_MANGA_MID_AD: import.meta.env.VITE_ENABLE_MANGA_MID_AD,
  MANGA_MID_AD_ZONE_ID: import.meta.env.VITE_MANGA_MID_AD_ZONE_ID,
  ENABLE_FOOTER_AD: import.meta.env.VITE_ENABLE_FOOTER_AD,
  FOOTER_AD_ZONE_ID: import.meta.env.VITE_FOOTER_AD_ZONE_ID,
  ENABLE_ONBOARDING_AD: import.meta.env.VITE_ENABLE_ONBOARDING_AD,
  ONBOARDING_AD_ZONE_ID: import.meta.env.VITE_ONBOARDING_AD_ZONE_ID,
  ADSTERRA_SCRIPT_HOST: import.meta.env.VITE_ADSTERRA_SCRIPT_HOST,
  ENABLE_PRIMARY_BANNER_GIF: import.meta.env.VITE_ENABLE_PRIMARY_BANNER_GIF,
...
export function conf(): RuntimeConfig {
  return {
    ...
    ENABLE_SECONDARY_RAIL_AD:
      getKey("ENABLE_SECONDARY_RAIL_AD", "false") === "true",
    ENABLE_DISCOVER_SEAM_AD:
      getKey("ENABLE_DISCOVER_SEAM_AD", "false") === "true",
    DISCOVER_SEAM_AD_ZONE_ID: getKey("DISCOVER_SEAM_AD_ZONE_ID"),
    ENABLE_DISCOVER_AD: getKey("ENABLE_DISCOVER_AD", "false") === "true",
    DISCOVER_AD_ZONE_ID: getKey("DISCOVER_AD_ZONE_ID"),
    ENABLE_SEARCH_AD: getKey("ENABLE_SEARCH_AD", "false") === "true",
    SEARCH_AD_ZONE_ID: getKey("SEARCH_AD_ZONE_ID"),
    SEARCH_AD_MOBILE_ZONE_ID: getKey("SEARCH_AD_MOBILE_ZONE_ID"),
    ENABLE_MANGA_MID_AD: getKey("ENABLE_MANGA_MID_AD", "false") === "true",
    MANGA_MID_AD_ZONE_ID: getKey("MANGA_MID_AD_ZONE_ID"),
    ENABLE_FOOTER_AD: getKey("ENABLE_FOOTER_AD", "false") === "true",
    FOOTER_AD_ZONE_ID: getKey("FOOTER_AD_ZONE_ID"),
    ENABLE_ONBOARDING_AD: getKey("ENABLE_ONBOARDING_AD", "false") === "true",
    ONBOARDING_AD_ZONE_ID: getKey("ONBOARDING_AD_ZONE_ID"),
    ADSTERRA_SCRIPT_HOST: getKey("ADSTERRA_SCRIPT_HOST"),
    ENABLE_PRIMARY_BANNER_GIF:
      getKey("ENABLE_PRIMARY_BANNER_GIF", "false") === "true",
